...
from mainApp.apis.training_session_api import *
from mainApp.models import TrainingRegistration
...
urlpatterns = [
    ...
    path('trs/<int:trs_id>', TrainingRegistrationApi.as_view()),
    path('trg/confirm', confirm)
